    ...
    <div class="container">
        ...
        <div class="section-info py-md-5">
          <div class="container py-md-3">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-4">
                <img src="/img/picbed/f1.jpg" class="img-fluid shadow-z-depth-2 rounded" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        ...
        <div class="row wow fadeIn">
          ...
          <div class="col-md-6 mb-4">
            <img src="/img/picbed/f3.jpg" class="img-fluid shadow-z-depth-2 rounded" alt="" />
          </div>
        </div>
        <div id="theme"></div>
      </section>
