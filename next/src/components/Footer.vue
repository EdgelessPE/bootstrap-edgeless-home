<template>
  <footer class="page-footer text-center font-small mt-4 wow fadeIn">
    ...
    <div class="footer-copyright py-3">
      ...
      <br /><br /><br /><br />
      <h1>Edgeless服务器赞助商</h1>
      <br /><br />
      <a href="https://wngamebox.cn/" target="_blank">
        <img src="/img/wngamebox.png" height="120" width="490" />
      </a>
    </div>
  </footer>
</template>
