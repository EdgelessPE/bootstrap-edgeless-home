    ...
    <div class="pt-4" id="py">
      ...
      <div class="flex justify-center gap-16">
        <div class="flex items-center gap-2">
          <svg style="margin-top: -3px;" t="1635599987840" class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="2100" width="20" height="20">
            <path
        ...
        <div class="flex items-center gap-2">
          <svg style="margin-top: -2.5px;" t="1635599866364" class="icon" viewBox="0 0 1088 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="2057" width="20" height="20">
            <path
          ...
          <a href="https://github.com/EdgelessPE/Edgeless/issues">问题反馈</a>
        </div>
      </div>
    </div>
